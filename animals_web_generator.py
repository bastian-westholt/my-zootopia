...
def get_data(animals_data):
    ...
    for animal in animals_data:
        animals_data_str += f'Name: {animal["name"]}\n'
        animals_data_str += f'Diet: {animal["characteristics"]["diet"]}\n'
        animals_data_str += f'Location: {animal["locations"][0]}\n'
        if "type" in animal["characteristics"]:
            animals_data_str += f'Type: {animal["characteristics"]["type"]}\n'
        animals_data_str += '\n'
